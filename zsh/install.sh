...
cat <(curl -s https://raw.githubusercontent.com/tornermarton/toolkit/master/zsh/tools/variables.sh)
echo '#------------------------------ ALIASES ---------------------------------'
...
echo '#------------------------------ PROMPT ----------------------------------'
cat <(curl -s https://raw.githubusercontent.com/tornermarton/toolkit/master/zsh/tools/prompt.sh)
